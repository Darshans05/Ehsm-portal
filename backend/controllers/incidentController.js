...
exports.getIncidents = async (req, res, next) => {
    try {
        console.log(`[Incident Controller] GET /api/incidents - Querying SAP IncidentSet`);
        ...
        if (Array.isArray(results)) {
            console.log(`[Incident Controller] Successfully fetched ${results.length} incidents from SAP.`);
        ...
        console.warn(`[Incident Controller] SAP Incident OData fetch failed, shifting to local mock data:`, error.message);
